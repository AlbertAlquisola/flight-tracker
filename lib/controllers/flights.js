...
function getFlight(options, callback) {
  const url = new URL(`${quoteEndpoint}/${options.country}/${options.currency}/${options.locale}/${options.originPlace}/${options.destinationPlace}/${options.outboundDate}/${options.inboundDate}/`);
